 ...
 */
// 預先載入所有食材圖片
const ingredientImages = import.meta.glob('@/assets/ingredients/*.png', { eager: true });
// 建立 id -> 圖片 URL 的映射
const imageMap = {};
 ...
 */
export function getIngredientImageUrl(ingredientId) {
 ...
 * @returns 是否有本地圖片
 */
export function hasLocalImage(ingredientId) {
 ...
 * @returns 食材 ID 陣列
 */
export function getAvailableImageIds() {
...
//# sourceMappingURL=useIngredientImage.js.map